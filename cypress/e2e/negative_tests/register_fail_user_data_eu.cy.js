describe('template spec', () => {
    it('Register test failed 2 part', () => {
        cy.fixture('newCypressTest').then(data => {
            ...
            cy.get('[style=""] > :nth-child(1) > .form-control--medium > .form-input--text').type(data.none_existent_name_eu)

            cy.log('Ввод некорректного имя')
            cy.get(':nth-child(2) > .form-control--medium > .form-input--text').type(data.none_existent_surname_eu)
